...
public class WorkerProcess {
	public static void main(String[] args) {
		...
		// Populate the list of classes for each student by navigating to each student's page
...
//			// Login to GitHub and grab the right repository
			...
			if (!gitHubAssignments.equals(aspenAssignments)) {
				...
				String commitSha = ghRepo.createCommit()
						.message("aspen updated - " + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()))
